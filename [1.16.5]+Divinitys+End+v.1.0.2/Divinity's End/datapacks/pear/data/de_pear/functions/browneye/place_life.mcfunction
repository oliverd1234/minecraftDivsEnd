...
summon bat -277 58 -1475.0 {Silent:1b,Invulnerable:1b,Health:1000f,Tags:["life_spirit","barrier_spirit"],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:20000000}],Attributes:[{Name:generic.max_health,Base:1000}]}
