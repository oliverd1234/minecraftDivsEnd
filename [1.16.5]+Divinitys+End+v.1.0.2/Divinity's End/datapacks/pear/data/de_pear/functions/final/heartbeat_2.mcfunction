playsound minecraft:block.note_block.basedrum master @a[predicate=de_pear:areas/final_monster,predicate=!de_pear:areas/final_monster_heart] 2808 178 -114 7 0.5
...
schedule function de_pear:final/heartbeat_1 24t
