playsound minecraft:block.note_block.basedrum master @a[predicate=de_pear:areas/final_monster_heart_close] 2808 178 -114 8 0.75

playsound minecraft:block.conduit.ambient ambient @a[predicate=de_pear:areas/final_monster_heart_close] 2808 178 -114 6 0.5
...
schedule function de_pear:final/heartbeat_very_frantic_2 3t
